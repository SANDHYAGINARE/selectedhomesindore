        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="text-3xl font-bold tracking-tight mb-4">
              Ready to Find Your Perfect Property in Indore?
            </h2>
            <p className="text-primary-foreground/80 mb-6 max-w-lg">
              Whether you're looking for a rental property, guest house,
              commercial space, or a property to buy, our team of experts is
              ready to help you find the perfect match for your needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-primary-foreground/20 hover:bg-primary-foreground/10 text-foreground"
              >
          ...
          <div className="bg-primary-foreground/10 p-6 rounded-lg backdrop-blur-sm border border-primary-foreground/20">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                <span className="mr-2 text-xl">•</span>
                <span>
                  Specialized options for students, couples, families, and
                  businesses
                </span>
              </li>
              <li className="flex items-start">
